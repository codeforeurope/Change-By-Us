...
tc.gam.idea_widgets.conversation = function(options){
    ...
    var dom = options.dom,
        ...
        runtime_data = {
            message_filter: 'all',
            n_to_fetch: 10,
            offset: options.idea_data.conversation.messages.n_returned
        },
        state = {
    ...
    var handlers = {
        ...
        change_message_filter: function (e, d) {
            ...
            tc.jQ.ajax({
                ...
                url: "/idea/messages",
                data: {
                    idea_id: options.idea_data.idea_id,
            ...
            steps: {
                ...
                'message': {
                    ...
                    finish: function (merlin, dom) {
                        ...
                        merlin.options.data = {
                            idea_id: merlin.app.app_page.data.idea.idea_id,
